  ...
  const footerData: FooterSection[] = [
    {
      title: "Company",
      links: [
        { name: translate('navAboutUs', "About Us"), appView: AppView.ABOUT_US },
        { name: translate('careers', "Careers"), action: () => alert("Careers page coming soon!") }, 
        { name: translate('press', "Press"), action: () => alert("Press page coming soon!") }, 
      ],
    },
    {
      title: "Services",
    ...
    {
      title: "Support", // This section can be re-evaluated. For now, FAQs and Contact Us are now part of "About Us"
      links: [
        // { name: translate('faq', "FAQs"), action: () => onNavigate(AppView.ABOUT_US) }, // Now part of About Us page
        // { name: translate('contactUs', "Contact Us"), action: () => onNavigate(AppView.ABOUT_US) }, // Now part of About Us page
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 border-t border-slate-700 pt-8 text-center">
          <p className="text-base text-slate-400">
            &copy; {new Date().getFullYear()} SmartGarage. All rights reserved. 
          </p>
