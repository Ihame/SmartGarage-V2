...
import { CarIcon, BatteryIcon, WrenchScrewdriverIcon, UsersIcon, ShoppingCartIcon, WrenchIcon as GarageIcon } from './common/Icon';
...
const LandingPage: React.FC<LandingPageProps> = ({ onNavigate }) => {
  ...
  const services: ServiceCardProps[] = [
    {
      ...
      description: "Submit your EV/Hybrid's issue and vehicle details. Our e-mechanics will review your information and contact you for a full consultation and service details.", // Updated description
      price: translate('vdPriceInfo', "Full Service Involves Fee"),
      icon: <CarIcon />,
      actionText: translate('startAIDiagnosis', "Start Diagnosis"), // Updated button text key
    ...
    },
    {
      ...
      description: translate('batteryPredictionDesc',"Receive a preliminary insight into your battery's health. Provide your details, and our specialists will contact you for a more comprehensive analysis to protect your high-value battery component."), // Updated description
    ...
    {
      title: translate('navOBDShop', "OBD Info"), 
  ...
  const stats = [
    ...
    { name: translate('statAvgResponseTime', 'Avg. E-Mechanic Response Time'), value: '<24 Hrs' }, // Updated stat
  ];
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <div className="mt-10 md:mt-12 flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <Button 
              size="xl" 
              variant="ghost" 
              onClick={() => onNavigate(AppView.OBD_SHOP)} 
