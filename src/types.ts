...
export enum VirtualDiagnosisStep {
  ...
  SUBMITTING_DIAGNOSIS = 'SUBMITTING_DIAGNOSIS', // Intermediate processing step
  VIEW_AI_REPORT = 'VIEW_AI_REPORT', // Now "Review Information" step
...
export interface FAQItem {
  ...
  answerKey: string;   // Translation key for the answer
}
