...
import { Language, Testimonial, Translations, OBDProduct, AppView, VirtualDiagnosisStep, StepConfig, CommunityPost, CarBrand, FAQItem } from './types';

export const API_KEY_ENV_VAR = 'API_KEY'; // For Gemini (though Gemini is being removed from VD)
...
export const VIRTUAL_DIAGNOSIS_STEPS_CONFIG: StepConfig[] = [
  ...
  // SUBMITTING_DIAGNOSIS is an intermediate state, not shown in progress bar typically
  { id: VirtualDiagnosisStep.VIEW_AI_REPORT, titleKey: 'vdStepViewDataReview' }, // Changed titleKey
...
export const TRANSLATIONS: Translations = {
  ...
  navVirtualDiagnosis: { [Language.EN]: "Virtual Diagnosis", [Language.RW]: "Isuzuma Ryihuse" }, 
  ...
  navSupport: { [Language.EN]: "Support", [Language.RW]: "Ubufasha" }, // Kept for potential future use, though removed from main nav
  ...
  navAboutUs: { [Language.EN]: "About Us", [Language.RW]: "Abo Turi Bo" }, 
  ...
  startAIDiagnosis: { [Language.EN]: "Start Diagnosis", [Language.RW]: "Tangira Isuzuma" }, 
  ...
  statAvgResponseTime: { [Language.EN]: "Avg. E-Mechanic Response Time", [Language.RW]: "Igihe E-Mechanic Asubiriza" }, 
  ...
  vdStepViewDataReview: { [Language.EN]: "3. Review", [Language.RW]: "3. Gusuzuma Amakuru" }, 
  vdStepEMechanicConsultationPaymentInfo: { [Language.EN]: "4. E-Mechanic Process", [Language.RW]: "4. Uko E-Mechanic Akora" }, 
  ...
  vdSubmitForReview: { [Language.EN]: "Submit for E-Mechanic Review", [Language.RW]: "Ohereza Ngo E-Mechanic Asuzume" }, 
  vdProcessingInfo: { [Language.EN]: "Processing your information...", [Language.RW]: "Turimo gutunganya amakuru yawe..." }, 
  vdDataReviewTitle: { [Language.EN]: "Information Submitted for Review", [Language.RW]: "Amakuru Yoherejwe Ngo Asuzumwe" }, 
  vdDataReviewInfo: { [Language.EN]: "Your vehicle information has been successfully collected. Our e-mechanic team will review your submission and contact you shortly. Please proceed to provide your contact details.", [Language.RW]: "Amakuru y'imodoka yawe yakusanyijwe neza. Itsinda ryacu ry'aba e-mechanic rizasuzuma ibyo wohereje kandi rizakwandikira vuba. Nyamuneka komeza utange amakuru yawe yo guhamagarwa." }, 
  
  vdEMechanicConsultationTitle: { [Language.EN]: "E-Mechanic Consultation & Full Diagnosis", [Language.RW]: "Ubujyanama bw'E-Mechanic na Raporo Yuzuye" }, 
  vdEMechanicConsultationText: { [Language.EN]: "Our certified e-mechanics will review your submitted details and contact you for a consultation. During this consultation, they will discuss your case, potential diagnostic steps, and any applicable fees for a full diagnostic report, repair guidance, or cost estimates.", [Language.RW]: "Aba e-mechanic bacu bemewe bazasuzuma amakuru watanze maze bakwandikire muganire. Muri iyo nama, bazaganira ku kibazo cyawe, intambwe zishobora guterwa mu gusuzuma, n'amafaranga yose ashobora kwishyurwa kuri raporo yuzuye y'isuzuma, amabwiriza yo gukora, cyangwa igereranya ry'ibiciro." }, 
  ...
  vdEMechanicConfirmationPaymentCode: { [Language.EN]: "Thank you! Your request has been submitted. Our e-mechanic team will review your information and contact you via {contactMethod} shortly to discuss your case and any next steps or payment details for further services. Please check your messages/calls.", [Language.RW]: "Murakoze! Ubusabe bwawe bwakiriwe. Itsinda ryacu ry'aba e-mechanic rizasuzuma amakuru yawe kandi rizakwandikira kuri {contactMethod} vuba ngo muganire ku kibazo cyawe n'intambwe zikurikira cyangwa amakuru yo kwishyura serivisi zindi. Nyamuneka reba ubutumwa/guhamagarwa kwawe." }, 
  ...
  reportSectionPotentialProblems: { [Language.EN]: "Initial Assessment", [Language.RW]: "Isuzuma ry'Ibanze" }, // Simplified
  reportSectionImmediateChecks: { [Language.EN]: "User Notes", [Language.RW]: "Ibyo Umukoresha Yanditse" }, // Simplified
  reportSectionProfessionalRecs: { [Language.EN]: "Next Steps", [Language.RW]: "Intambwe Zikurikira" }, // Simplified
  reportSectionUrgency: { [Language.EN]: "Urgency", [Language.RW]: "Ubwihutirwe" },
  reportSectionSummary: { [Language.EN]: "Summary", [Language.RW]: "Incāmāke" },
  reportSectionImageNotes: { [Language.EN]: "Image Notes", [Language.RW]: "Ibitekerezo ku Ifoto" },
  reportSectionDisclaimer: { [Language.EN]: "Disclaimer", [Language.RW]: "Itangazo Ryihariye" },
  confidenceHigh: { [Language.EN]: "High", [Language.RW]: "Haringaniye Cyane" }, // Kept for consistency if service evolves
  ...
  batteryPredictionDesc: { [Language.EN]: "Get insights into your battery's health and estimated lifespan. Understand how your driving and charging habits affect it, crucial for these high-value components.", [Language.RW]: "Menya byinshi ku buzima bwa batiri yawe n'igihe ishobora kumara. Sobanukirwa uko imigendere yawe n'uburyo bwo gusharija bigira ingaruka, ni ingenzi cyane kuri ibi bice by'agaciro kanini." },
  ...
  bpGenericInsight: { [Language.EN]: "Based on typical usage for vehicles like yours, your battery appears to be performing within expected parameters. For a detailed lifespan prediction, degradation analysis, and personalized charging advice to protect your high-value battery, please provide your contact details. Our specialists will reach out.", [Language.RW]: "Dushingiye ku mikoreshereze isanzwe y'imodoka nk'iyawe, batiri yawe isa n'aho iri gukora neza. Kugira ngo ubone raporo irambuye ku gihe ishobora kumara, isesengura ry'isenyuka ryayo, n'inama zihariye zo gusharija mu kurengera batiri yawe y'agaciro, nyamuneka tanga amakuru yawe. Abahanga bacu bazakwandikira." },
  ...
  registrationSuccess: { [Language.EN]: "Registration successful!", [Language.RW]: "Wiyandikishije neza!" }, 
  ...
  // About Us Page
  aboutUsTitle: { [Language.EN]: "Who We Are", [Language.RW]: "Abo Turi Bo" },
  aboutUsHeroHeadline: { [Language.EN]: "Pioneering the Future of Sustainable Mobility in Africa.", [Language.RW]: "Tuyoboye Ejo Hazaza h'Urugendo Rurambye muri Afurika." },
  aboutUsHeroSubtext: { [Language.EN]: "SmartGarage is dedicated to providing intelligent, reliable, and accessible care for Electric and Hybrid vehicles.", [Language.RW]: "SmartGarage yiyemeje gutanga serivisi z'ubwenge, zizewe, kandi zigerwaho ku modoka z'amashanyarazi na Hybrid." },
  ourMission: { [Language.EN]: "Our Mission", [Language.RW]: "Intego Yacu" },
  ourMissionText: { [Language.EN]: "To empower EV and Hybrid owners and technicians across Africa with cutting-edge diagnostic tools, predictive maintenance solutions, and a supportive community, fostering a cleaner and more sustainable automotive future.", [Language.RW]: "Guha imbaraga abafite imodoka za EV na Hybrid n'abatekinisiye muri Afurika yose dukoresheje ibikoresho bigezweho byo gusuzuma, ibisubizo byo kumenya mbere ibizaba, n'umuryango ushyigikira, duteza imbere ejo hazaza h'imodoka zisukuye kandi zirambye." },
  ourVision: { [Language.EN]: "Our Vision", [Language.RW]: "Icyerekezo Cyacu" },
  ourVisionText: { [Language.EN]: "To be the leading and most trusted partner for EV and Hybrid vehicle care in Africa, recognized for our innovation, expertise, and commitment to customer success.", [Language.RW]: "Kuba umufatanyabikorwa w'imbere kandi wizewe mu kwita ku modoka za EV na Hybrid muri Afurika, tuzwiho udushya, ubuhanga, n'ubwitange ku ntsinzi y'abakiriya." },
  ourValues: { [Language.EN]: "Our Values", [Language.RW]: "Indangagaciro Zacu" },
  valueIntegrity: { [Language.EN]: "Integrity", [Language.RW]: "Ubunyangamugayo" },
  valueIntegrityDesc: { [Language.EN]: "Upholding the highest ethical standards in all our interactions.", [Language.RW]: "Gukurikiza amahame meza y'imyitwarire mu bikorwa byacu byose." },
  valueInnovation: { [Language.EN]: "Innovation", [Language.RW]: "Udushya" },
  valueInnovationDesc: { [Language.EN]: "Continuously seeking and implementing advanced solutions for automotive care.", [Language.RW]: "Guhora dushakisha no gushyira mu bikorwa ibisubizo bigezweho mu kwita ku modoka." },
  valueCustomerCentricity: { [Language.EN]: "Customer-Centricity", [Language.RW]: "Kugira Umukiriya ku Mutima" },
  valueCustomerCentricityDesc: { [Language.EN]: "Placing our customers' needs and satisfaction at the forefront of everything we do.", [Language.RW]: "Gushyira ibyifuzo by'abakiriya bacu n'uko banyuzwe imbere y'ibyo dukora byose." },
  valueSustainability: { [Language.EN]: "Sustainability", [Language.RW]: "Kuramba" },
  valueSustainabilityDesc: { [Language.EN]: "Promoting environmentally friendly practices and technologies in the automotive sector.", [Language.RW]: "Guteza imbere ibikorwa birengera ibidukikije n'ikoranabuhanga mu rwego rw'imodoka." },
  valueCollaboration: { [Language.EN]: "Collaboration", [Language.RW]: "Ubufatanye" },
  valueCollaborationDesc: { [Language.EN]: "Working together with partners and the community to achieve shared goals.", [Language.RW]: "Gukorana n'abafatanyabikorwa n'umuryango mugari kugira ngo tugere ku ntego duhuriyeho." },
  whyBatteries: { [Language.EN]: "Our Focus on EV & Hybrid Batteries", [Language.RW]: "Twibanda Kuri Batiri za EV & Hybrid" },
  whyBatteriesText: { [Language.EN]: "Electric and Hybrid vehicle batteries are marvels of technology, but they represent a significant investment. Proactive and predictive maintenance is crucial to maximize their lifespan and performance, preventing costly unexpected failures. At SmartGarage, we leverage advanced AI and data analytics to offer specialized battery health assessments and predictive insights, helping you protect your investment and ensure your vehicle's longevity. This is more than just maintenance; it's peace of mind for the heart of your EV.", [Language.RW]: "Batiri z'imodoka z'amashanyarazi na Hybrid ni ibitangaza by'ikoranabuhanga, ariko zihagarariye ishoramari rinini. Kubungabunga no kumenya mbere ibibazo ni ingenzi cyane kugira ngo zimare igihe kirekire kandi zikore neza, bikumira ibibazo bihenze bitunguranye. Muri SmartGarage, dukoresha AI igezweho n'isesengura ry'amakuru kugira ngo dutange isuzuma ryihariye ry'ubuzima bwa batiri n'ubushishozi bwo kumenya mbere ibishobora kuba, bigufasha kurinda ishoramari ryawe no kwizeza kuramba kw'imodoka yawe. Ibi birenga kubungabunga gusa; ni amahoro yo mu mutima ku mutima w'imodoka yawe ya EV." },
  ourTeam: { [Language.EN]: "Our Team", [Language.RW]: "Ikipe Yacu" },
  ourTeamText: { [Language.EN]: "Meet our passionate team of engineers, AI specialists, and automotive experts dedicated to revolutionizing vehicle care in Africa. (More details coming soon!)", [Language.RW]: "Hura n'ikipe yacu y'abahanga mu bya engineering, AI, n'imodoka biyemeje guhindura uko imodoka zitabwaho muri Afurika. (Amakuru arambuye azaza vuba!)" },
  learnMoreAboutServices: { [Language.EN]: "Learn More About Our Services", [Language.RW]: "Menya Byinshi Kuri Serivisi Zacu" },
  exploreServices: { [Language.EN]: "Explore Services", [Language.RW]: "Reba Serivisi"},
  careers: { [Language.EN]: "Careers", [Language.RW]: "Imyanya y'Akazi" },
  press: { [Language.EN]: "Press", [Language.RW]: "Itangazamakuru" },
  faq: { [Language.EN]: "FAQs", [Language.RW]: "Ibibazo Bikunze Kubazwa"},
  contactUs: { [Language.EN]: "Contact Us", [Language.RW]: "Twandikire"},
  faqTitle: { [Language.EN]: "Frequently Asked Questions", [Language.RW]: "Ibibazo Bikunze Kubazwa" },
  contactUsTitle: { [Language.EN]: "Get in Touch", [Language.RW]: "Twandikire" },
  contactUsInfo: { [Language.EN]: "Have questions or want to learn more? Reach out to us!", [Language.RW]: "Ufite ibibazo cyangwa ushaka kumenya byinshi? Twandikire!" },
  ourEmail: { [Language.EN]: "Our Email", [Language.RW]: "Email Yacu" },
  ourPhone: { [Language.EN]: "Our Phone", [Language.RW]: "Telefone Yacu" },
  sendMessage: { [Language.EN]: "Send Message", [Language.RW]: "Ohereza Ubutumwa" },
  messagePlaceholder: { [Language.EN]: "Your message here...", [Language.RW]: "Ubutumwa bwawe hano..." },
  contactFormSuccess: { [Language.EN]: "Thank you for your message! We'll get back to you soon.", [Language.RW]: "Murakoze ku butumwa bwanyu! Turabasubiza vuba." },
  contactFormError: { [Language.EN]: "Sorry, something went wrong. Please try again later.", [Language.RW]: "Mbabarira, habaye ikibazo. Nyamuneka ongera ugerageze nyuma." },
  
  // Sample FAQs
  faqQ1: { [Language.EN]: "What services does SmartGarage offer?", [Language.RW]: "Ni serivisi izihe SmartGarage itanga?" },
  faqA1: { [Language.EN]: "SmartGarage offers Virtual Diagnosis, Battery Life Prediction, Spares Part Sourcing, OBD Scanner Info, Garage ERP Solutions, and a Community Hub for EV/Hybrid owners.", [Language.RW]: "SmartGarage itanga Isuzuma Ryihuse, Kumenya Ubuzima bwa Batiri, Gushaka Ibyuma, Amakuru kuri OBD, Ibisubizo bya ERP ku Magaraji, n'Umuryango w'abafite EV/Hybrid." },
  faqQ2: { [Language.EN]: "Is the Virtual Diagnosis free?", [Language.RW]: "Ese Isuzuma Ryihuse ni ubuntu?" },
  faqA2: { [Language.EN]: "The initial information collection for Virtual Diagnosis is free. A full diagnosis and consultation with an e-mechanic involves a fee, which will be communicated by the e-mechanic.", [Language.RW]: "Gukusanya amakuru y'ibanze ku Isuzuma Ryihuse ni ubuntu. Isuzuma ryuzuye n'ubujyanama n'e-mechanic bisaba kwishyura, e-mechanic akazabikumenyesha." },
  faqQ3: { [Language.EN]: "How accurate is the Battery Life Prediction?", [Language.RW]: "Kumenya Ubuzima bwa Batiri ni ukuri ku kihe kigero?" },
  faqA3: { [Language.EN]: "We provide a preliminary insight based on your input. For a detailed and more accurate prediction, our specialists will contact you to gather more specific data and perform a comprehensive analysis.", [Language.RW]: "Dutanga incamake y'ibanze ishingiye ku byo watanze. Kugira ngo ubone ibipimo birambuye kandi nyabyo, abahanga bacu bazakwandikira kugira ngo bakusanye andi makuru yihariye kandi bakore isesengura ryuzuye." },
  faqQ4: { [Language.EN]: "How do I join the Community Hub?", [Language.RW]: "Nakwinjira nte mu Muryango?" },
  faqA4: { [Language.EN]: "You can view posts in the Community Hub freely. To create posts and engage fully, you need to register and log in to your SmartGarage account.", [Language.RW]: "Ushobora kureba ubutumwa mu Muryango ku buntu. Kugira ngo wandike ubutumwa kandi wigire uruhare rwuzuye, ugomba kwiyandikisha no kwinjira muri konti yawe ya SmartGarage." },
  faqQ5: { [Language.EN]: "What kind of support do you offer for garages?", [Language.RW]: "Ni ubuhe bufasha mutanga ku magaraji?" },
  faqA5: { [Language.EN]: "We offer SmartGarage ERP, a comprehensive software solution to streamline operations, manage EV parts inventory, schedule appointments, and enhance customer relationships for modern auto shops.", [Language.RW]: "Dutanga SmartGarage ERP, porogaramu yuzuye yo koroshya ibikorwa, gucunga ibikoresho by'imodoka za EV, guteganya gahunda, no kunoza umubano n'abakiriya ku magaraji agezweho." },
  ...
  errorRLSPermission: { [Language.EN]: "Submission failed due to permission issues. Please ensure you're logged in. If the problem persists, contact support.", [Language.RW]: "Kohereza byanze kubera ibibazo by'uburenganzira. Nyamuneka menya neza ko winjiye. Niba ikibazo gikomeje, vugana n'ubufasha." },
  ...
  errorAIResponseFormat: { [Language.EN]: "Information processing error. Please try again.", [Language.RW]: "Ikosa mu gutunganya amakuru. Nyamuneka ongera ugerageze." }, 
  ...
  confirmation: { [Language.EN]: "Confirmation", [Language.RW]: "Kwemeza"}, 
};